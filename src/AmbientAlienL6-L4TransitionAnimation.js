/**
 *  @file       AmbientAlienL6-L4TransitionAnimation.js
 *
 *
    ...
    this.level6Seg0Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(140, 82, props.brightness).mix(Color.hsv(219, 20, 100), 0.5)
        );
      });

    this.level6Seg1Tween = new TWEEN.Tween(Object.assign({}, initial))
      .to(Object.assign({}, dest), 0)
      .delay(800)
      .easing(TWEEN.Easing.Elastic.InOut)
      .yoyo(true)
      .repeat(1)
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(150, 82, props.brightness).mix(Color.hsv(150, 20, 100), 0.5)
        );
      });    
    ...
    this.level6Seg2Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(160, 82, props.brightness).mix(Color.hsv(160, 20, 100), 0.5)
        );
      });    
    ...
    this.level6Seg3Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(170, 82, props.brightness).mix(Color.hsv(170, 20, 100), 0.5)
        );
      }); 
    ...
    this.level6Seg4Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(180, 82, props.brightness).mix(Color.hsv(180, 20, 100), 0.5)
        );
      }); 
    ...
    this.level6Seg5Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(190, 82, props.brightness).mix(Color.hsv(190, 20, 85), 0.5)
        );
      }); 
    ...
    this.level4Seg0Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(200, 82, props.brightness).mix(Color.hsv(200, 20, 85), 0.5)
        );
      }); 
    ...
    this.level4Seg1Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(210, 82, props.brightness).mix(Color.hsv(210, 20, 85), 0.5)
        );
      }); 
    ...
    this.level4Seg2Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(220, 82, props.brightness).mix(Color.hsv(220, 20, 85), 0.5)
        );
      }); 
    ...
    this.level4Seg3Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(230, 82, props.brightness).mix(Color.hsv(230, 20, 85), 0.5)
        );
      }); 
    ...
    this.level2Seg0Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(240, 82, props.brightness).mix(Color.hsv(240, 20, 85), 0.5)
        );
      }); 
    ...
    this.level2Seg1Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          ...
          Color.hsv(250, 82, props.brightness).mix(Color.hsv(250, 20, 85), 0.5)
        );
      }); 
  }
  start () {
