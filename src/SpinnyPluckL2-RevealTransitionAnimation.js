...
class IdleModeAnimation extends ControllerWithStore {
  ...
  build () {
    ...
    this.level6Seg0Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_6-segment_0': Color.hsv(26, 100, props.brightness).mix(Color.hsv(22, 82, 100), 0.1),
        );
      });
    ...
    this.level6Seg1Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_6-segment_1': Color.hsv(27, 100, props.brightness).mix(Color.hsv(32, 100, 100), 0.1),
        );
      });    
    ...
    this.level6Seg2Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_6-segment_2': Color.hsv(28, 100, props.brightness).mix(Color.hsv(33, 100, 100), 0.1),
        );
      });    
    ...
    this.level6Seg3Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_6-segment_3': Color.hsv(29, 100, props.brightness).mix(Color.hsv(34, 100, 100), 0.1),
        );
      }); 
    ...
    this.level6Seg4Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_6-segment_4': Color.hsv(30, 100, props.brightness).mix(Color.hsv(35, 100, 100), 0.1),
        );
      }); 
    ...
    this.level6Seg5Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_6-segment_5': Color.hsv(31, 100, props.brightness).mix(Color.hsv(36, 100, 100), 0.1),
        );
      }); 
    ...
    this.level4Seg0Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_4-segment_0': Color.hsv(32, 100, props.brightness).mix(Color.hsv(37, 100, 100), 0.1),
        );
      }); 
    ...
    this.level4Seg1Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_4-segment_1': Color.hsv(33, 100, props.brightness).mix(Color.hsv(38, 100, 100), 0.1),
        );
      }); 
    ...
    this.level4Seg2Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_4-segment_2': Color.hsv(34, 100, props.brightness).mix(Color.hsv(39, 100, 100), 0.1),
        );
      }); 
    ...
    this.level4Seg3Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_4-segment_3': Color.hsv(35, 100, props.brightness).mix(Color.hsv(40, 100, 100), 0.1),
        );
      }); 
    ...
    this.level2Seg0Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_2-segment_0': Color.hsv(36, 100, props.brightness).mix(Color.hsv(41, 100, 100), 0.1),
        );
      }); 
    ...
    this.level2Seg1Tween = new TWEEN.Tween(Object.assign({}, initial))
      ...
      .onUpdate((props) => {
        setPixelsColors(
          'level_2-segment_1': Color.hsv(37, 100, props.brightness).mix(Color.hsv(42, 100, 100), 0.1),
        );
      }); 
  }
  start () {
